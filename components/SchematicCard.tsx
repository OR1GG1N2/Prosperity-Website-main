...
export default function SchematicCard(props: {
	...
	return (
		<div className="p-4 pb-6 block hover:bg-zinc-900 text-left rounded-md duration-200 transform focus:border-sky-400 bg-zinc-800 border border-zinc-700 w-full">
			<Image
